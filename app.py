#This code created by Pancho (contact.frann@gmail.com // Pancho#1715)
#Este código ha sido creado por Pancho (contact.frann@gmail.com // Pancho#1715)

from tkinter import *

ventana = Tk()
ventana.title("Calculator by Pancho")
...
boton_parantesis1 = Button(ventana, text = "(", width = 5, height = 2, command = lambda: click_boton("("))
boton_parantesis2 = Button(ventana, text = ")", width = 5, height = 2, command = lambda: click_boton(")"))
